...
/////////////////LED CODE///////////////////////////////////////////////////////////////////////////
#define MAX_LED 20 //there are 20 leds
#define USE_BRIGHTNESS 1 //could be changed but not needed probably
...
//creates a perceptual brightness adjustment, meaning
//low brightness values drop off more smoothly
//high brightness doesn’t blow out as quickly
//compensates for how human eyes perceive brightness (nonlinear)
...
//clear display when no note is playing
